...
// Warna dalam tema Material Design untuk mode terang dan gelap

// Mode Terang
val md_theme_light_primary = Color(0xFF08285B)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFF253F83)
